...
/**
 * This class prompts the user for a set of coordinates, and then prints the
 * PointPC instance created.
 *
...
public class PointCPDesign4Test {
	...
	public static void main(String[] args) {
		...
		try {
			point = new PointCPDesign4(args[0].toUpperCase().charAt(0), Double
					.valueOf(args[1]).doubleValue(), Double.valueOf(args[2])
					.doubleValue());
		} catch (Exception e) {
